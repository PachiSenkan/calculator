...
FileList = [
    r'dip\models\ХВЗК Здоровые-Больные СлучайныйЛес 5деревъев 5глубина X-Свой4. vPub.pkcls',
    r'dip\models\ХВЗК Здоровые-Больные Дерево5 X-Свой4. vPub.pkcls',
    r'dip\models\ХВЗК Здоровые-Больные LogisticReg_L1_C=0. vPub.pkcls',
    r'dip\models\ХВЗК НЯК-НКК Дерево5 X-Свой4. vPub.pkcls',
    r'dip\models\ХВЗК НЯК-НКК LogisticReg_L1_C=0. vPub.pkcls',
]
